...
You don't need to alter yaml if you're not using a movement sensor in your build. If you're get issues with the 'floting' GPIO
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzY3NTE2MjM5LDE0NzQ0NjYyNzQsLTY0OT
