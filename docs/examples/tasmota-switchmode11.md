...
Things take time!! Especially when Appdeamon apps has to check HA states by eg. using constrain_input_boolean's (as in example 1) or toggle lights. On my setup using a 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg5OTY2ODYyNCwzNTUyMjA1MTcsLTE3Mj
